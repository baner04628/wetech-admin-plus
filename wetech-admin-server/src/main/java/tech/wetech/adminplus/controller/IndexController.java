package tech.wetech.adminplus.controller;
...
public class IndexController {
    ...
    public Result<List<Map<String, Object>>> getUserNav() {
        ...
        for (PermissionTreeDTO permission : permissionTreeDTOS) {
            try {
                Map<String, Object> userNav = JSONUtils.toObject(permission.getConfig(), Map.class);
